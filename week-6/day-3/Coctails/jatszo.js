...
1) with the base route (/), pass the cocktails list without filtering it

2) with /?alcohol={alcholType} route (for example /?alcohol=gin), filter the cocktails and pass only these that contains the selected alcohol
